...
namespace Pathfinding {
	...
	public abstract class AIBase : VersionedMonoBehaviour {
		 ...
		 * \note Takes a world space position, but returns a delta in the #movementPlane.
		 */
		 ...
		 * \param nextRotation New rotation of the agent. If #enableRotation is false then this parameter will be ignored.
		 *
