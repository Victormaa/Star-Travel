...
namespace Pathfinding {
	...
	public abstract class NavmeshBase : NavGraph, INavmesh, INavmeshHolder, ITransformedGraph
		 ...
		 * \see #navmeshUpdateData
		 */
		[JsonMember]
		public bool enableNavmeshCutting = true;

		/** Handles navmesh cutting.
		 * \see #enableNavmeshCutting
		 * \see #Pathfinding.NavmeshUpdates
		 */
		 ...
		 *
		 * \warning Do not modify this directly, instead use e.g. #RelocateNodes(GraphTransform)
		 */
